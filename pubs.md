...
* The [OSF repository](https://osf.io/29egh/) includes the R analysis code and R Markdown code to reproduce all tables, figures, and text in the results section.
