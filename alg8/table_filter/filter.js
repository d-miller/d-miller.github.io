...
(function() {
  ...
  //for some reason, adjust the scale to anything different than d3.scale.linear(), so instead
  ...
  var pwr10 = function(d) { return d3.format(",")( (d < 1) ? d*10 : 10**d); };
...
d3.csv('table_all.csv', (error, data) => {
