...
At AIR, I continued this teaching interest by co-developing webinars on highly technical updates to the WWC’s procedures and standards, such as webinars on [missing data standards](https://ies.ed.gov/ncee/wwc/multimedia/45) and [web-based tools to review studies](https://www.youtube.com/watch?v=wF7YxxtJddc). For instance, after deriving novel statistical formulas for [this Version 4.1 Supplement](https://ies.ed.gov/ncee/wwc/Docs/referenceresources/WWC-41-Supplement-508_09212020.pdf), I co-presented the changes to an audience of mostly PhD-level researchers and academic faculty ([slides here](https://ies.ed.gov/ncee/WWC/Docs/Multimedia/WWC-SWAT-SE-Suppl-508.pdf) or see below starting at 12:25):
