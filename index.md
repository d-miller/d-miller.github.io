...
I'm a researcher at American Institutes for Researcher, focusing on science, technology, engineering, and mathematics (STEM) education ([see C.V.]({{ site.baseurl }}/assets/MillerCV.pdf) or [Google Scholar profile](https://scholar.google.com/citations?user=z8nFnRUAAAAJ&hl=en)). Leading academic journals such as [_Child Development_]({{ site.baseurl }}/assets/MillerDAST.pdf), [_Journal of Educational Psychology_]({{ site.baseurl }}/assets/MillerEaglyLinn2015.pdf), and [_Trends in Cognitive Sciences_]({{ site.baseurl }}/assets/MillerHalpern2014.pdf) have published my research.
...
Twitter: [@davidimiller](https://twitter.com/davidimiller3)
