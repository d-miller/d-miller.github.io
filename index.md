...
Leveraging my meta-analysis expertise, I recently co-launched the $1M [Quantitative Evidence Synthesis Training (QuEST) program](https://www.air.org/project/quantitative-evidence-synthesis-training-quest-air-pipeline-partnership-program-p3) that will integrate virtual events, immersive training, and ongoing mentorship to support doctoral students at three minority-serving institutions (MSIs) in mastering the latest synthesis methodologies and developing meta-analysis projects aligned with students' academic aspirations.
