...
I'm a senior researcher at the [American Institutes for Research](https://www.air.org/experts/person/david-i-miller) (AIR) focusing on science, technology, engineering, and mathematics (STEM) education, especially STEM gender diversity and broadening participation in STEM. I currently lead a portfolio of work funded by the U.S. National Science Foundation (NSF) as Principal Investigator (PI) or co-PI on several NSF grants, including topics such as [children's](https://nsf.gov/awardsearch/showAward?AWD_ID=1920401) STEM ability stereotypes, [undergraduates'](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2110368) motivation and retention in STEM, and [gender biases](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2055422) in STEM higher education and workforce settings. I’m also a co-founder and current co-director of [AIR's Methods of Synthesis and Integration Center (MOSAIC)](https://mosaic.air.org/), which supports methods innovation across evidence synthesis projects at AIR.
