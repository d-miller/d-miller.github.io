...
Leveraging my meta-analysis expertise, I recently co-launched the $1M [Quantitative Evidence Synthesis Training (QuEST) program](https://www.air.org/project/quantitative-evidence-synthesis-training-quest-air-pipeline-partnership-program-p3) to support doctoral students in exploring and mastering research synthesis methodologies. These doctoral students will come from social and behavioral science programs at three minority-serving institutions (MSIs) that are part of [AIR's Pipeline Partnership Program](https://www.air.org/project/airs-pipeline-partnership-program): Georgia State University, Howard University, and University of Texas at San Antonio. Training activities will include virtual webinars, week-long immersive training workshops, and ongoing mentorship for supporting students in pursuiing indepedent meta-analysis projects aligned with their academic and professional aspirations. My co-PI role will be to co-develop the QuEST program's overall direction, in addition to developing curriculum and delivering instruction for specific training events (PI: [Laura Michaelson](https://www.air.org/experts/person/laura-michaelson)).
